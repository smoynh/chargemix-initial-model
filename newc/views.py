...
from newc.models import Grade, Element, Product, Chargemix, ChargemixProduct
from newc.serializers import GradeSerializer, ElementSerializer, ProductSerializer, ChargemixSerializer, ChargemixProductSerializer
